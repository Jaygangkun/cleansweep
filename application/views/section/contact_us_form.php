				...
				<div class="c-forms-template" sys:attach="dataview" dataview:data="{binding entry, source={{ Cognito.Forms.model }} }">
					<div class="c-forms-form-main c-span-24 c-sml-span-12">
                        ...
                        <div class="c-date-date c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required c-modified " data-field="CheckOutDate2">
                            <div class="c-label  "><label for="c-13-12">Check In Date</label></div>
                            <div class="c-editor">
                                <div class="c-editor-date"><input type="text" id="check_in_date" placeholder="" class="c-datepicker datepicker"></div>
                        ...
                        <div class="c-date-date c-field c-col-13 c-sml-col-1 c-span-12 c-sml-span-12  c-required c-modified " data-field="CheckOutTime">
                            <div class="c-label  "><label for="c-14-11">Check Out Date</label></div>
                            <div class="c-editor">
                                <div class="c-editor-date"><input type="text" id="check_out_date" placeholder="" class="c-datepicker datepicker"></div>
                                <div class="c-editor-date-icon"><i class="icon-calendar"></i></div>
                            </div>
                        ...
                        <div class="c-address c-address-us c-field c-col-1 c-sml-col-1 c-span-24 c-sml-span-12  c-required " data-field="CleaningPropertyAddress">
                            ...
                            <div>
                                <div class="c-offscreen"><label for="c-15-10"></label></div>
                                <div class="c-editor" style="float: left;"><input type="text" class="onlynumbs" id="bedrooms" placeholder=""></div>
                            </div>
                        ...
                        <div class="c-phone c-phone-us c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required " data-field="Phone">
                            <div class="c-label  "><label for="c-9-16"># of Bathrooms</label></div>
                            <div class="c-editor"><input type="text" class="onlynumbs" maxlength="10" id="bathrooms" placeholder=""></div>
                        ...
                        <div class="c-phone c-phone-us c-field c-col-13 c-sml-col-1 c-span-12 c-sml-span-12  c-required " data-field="CellPhone">
                            <div class="c-label  "><label for="c-10-15"># of ½ Bathrooms</label></div>
                            <div class="c-editor"><input type="text" class="onlynumbs" maxlength="10" id="hbathrooms" placeholder=""></div>
                            <div class="c-validation"># of ½ Bathrooms is required.</div>
                        </div>
                        ...
                        <div class="c-address c-address-us c-field c-col-1 c-sml-col-1 c-span-24 c-sml-span-12  c-required " data-field="CleaningPropertyAddress">
                            ...
                            <div class="custom-form-row">
                                <div class="custom-form-wrap custom-form-col-25">
                                    <div class="c-offscreen"><label for="c-16-10"></label></div>
                                    <div class="c-editor c-partial-line" style="float: left;"><input type="text" id="bed_conf_count1" placeholder=""></div>
                                    <div class="c-offscreen"><label for="c-16-10"></label></div>
                                    <div class="c-editor c-partial-line" style="float: left;">
                                        <div class="c-dropdown">
                                ...
                                <div class="custom-form-wrap custom-form-col-25">
                                    <div class="c-offscreen"><label for="c-16-10"></label></div>
                                    <div class="c-editor c-partial-line" style="float: left;"><input type="text" id="bed_conf_count2" placeholder=""></div>
                                    <div class="c-offscreen"><label for="c-16-10"></label></div>
                                    <div class="c-editor c-partial-line" style="float: left;">
                                        <div class="c-dropdown">
                                ...
                                <div class="custom-form-wrap custom-form-col-25">
                                    <div class="c-offscreen"><label for="c-16-10"></label></div>
                                    <div class="c-editor c-partial-line" style="float: left;"><input type="text" id="bed_conf_count3" placeholder=""></div>
                                    <div class="c-offscreen"><label for="c-16-10"></label></div>
                                    <div class="c-editor c-partial-line" style="float: left;">
                                        <div class="c-dropdown">
                                ...
                                <div class="custom-form-wrap custom-form-col-25">
                                    <div class="c-offscreen"><label for="c-16-10"></label></div>
                                    <div class="c-editor c-partial-line" style="float: left;"><input type="text" id="bed_conf_count4" placeholder=""></div>
                                    <div class="c-offscreen"><label for="c-16-10"></label></div>
                                    <div class="c-editor c-partial-line" style="float: left;">
                                        <div class="c-dropdown">
                        ...
                        <div class="c-phone c-phone-us c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required " data-field="Phone">
                            <div class="c-label  "><label for="c-9-16">Sleeper Sofa?</label></div>
                            <div class="c-editor">
                                <div class="c-dropdown">
                        ...
                        <div class="c-phone c-phone-us c-field c-col-13 c-sml-col-1 c-span-12 c-sml-span-12  c-required " data-field="CellPhone">
                            <div class="c-label  "><label for="c-10-15">Size</label></div>
                            <div class="c-editor">
                                <div class="c-dropdown">
                        ...
                        <div class="c-phone c-phone-us c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required " data-field="Phone">
                            <div class="c-label  "><label for="c-9-16">Owner's Day Phone</label></div>
                            <div class="c-editor"><input type="text" class="onlynumbs" maxlength="10" id="day_phone" placeholder="8036716089"></div>
                            <div class="c-validation">Daytime Phone is required.</div>
                        </div>
                        <div class="c-phone c-phone-us c-field c-col-13 c-sml-col-1 c-span-12 c-sml-span-12  c-required " data-field="CellPhone">
                            <div class="c-label  "><label for="c-10-15">Owner's Cell Phone</label></div>
                            <div class="c-editor"><input type="text" class="onlynumbs" maxlength="10" id="cell_phone" placeholder="8036716089"></div>
                            <div class="c-validation">Cell Phone is required.</div>
                        </div>
                                
                        <div class="c-phone c-phone-us c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required  " data-field="Phone">
                            <div class="c-label  "><label for="c-9-16">Owner's Email Address</label></div>
                            <div class="c-editor"><input type="text" id="email" placeholder="Email"></div>
