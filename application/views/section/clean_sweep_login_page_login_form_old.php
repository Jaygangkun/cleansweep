<div class="cognito c-safari c-lrg">
	...
	<form class="form-container" id="register_form">
		<div class="c-forms-form" tabindex="0">
			...
			<div class="c-forms-form-body">
				...
				<div class="c-forms-template" sys:attach="dataview" dataview:data="{binding entry, source={{ Cognito.Forms.model }} }">
					<div class="c-forms-form-main c-span-24 c-sml-span-12">
                        ...
                        <div class="c-phone c-phone-us c-field c-col-1 c-sml-col-1 c-span-12 c-sml-span-12  c-required " data-field="Phone">
                            ...
                            <div class="c-editor"><input type="text" class="onlynumbs" maxlength="10" id="daytime_phone" placeholder="8036716089"></div>
				...
				<div class="c-button-section">
					<div class="c-action"><button type="button" class="c-button" id="reg_submit_btn">Submit</button></div>
				</div>
			</div>
    ...
    <div style="display:block!important;text-align:center!important;padding:2px!important;max-width:800px!important;opacity:1!important;" class="ZsZBoSxMdEiZKkTOe5IReA" sys:attach="dataview" dataview:data="{binding entry, source={{ Cognito.Forms.model }} }"><a style="font-family: &quot;Open Sans&quot;, Helvetica, sans-serif !important; font-size: 12px !important; font-weight: bold !important; opacity: 1 !important; display: inline !important; text-decoration: none !important; color: rgb(68, 68, 68) !important;" href="https://www.cognitoforms.com//?crs=cmVmcHVibGljOjpMQ0NTMw==" target="_blank"><img style="vertical-align: middle; margin-right: 5px; border: none !important; width: auto !important; display: inline-block !important;" src="https://www.cognitoforms.com/Content/Images/cogicon.png" border="0" alt="Cognito Forms">Powered by Cognito Forms.</a></div>
</div>
