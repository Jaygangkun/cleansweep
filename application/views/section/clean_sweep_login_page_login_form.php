                        ...
                        <div class="c-forms-form-main c-span-24 c-sml-span-12">
                            <div class="c-name c-field c-col-1 c-sml-col-1 c-span-24 c-sml-span-12  c-required  " data-field="Name">
                                ...
                                <div>
                                    ...
                                    <div class="c-editor c-span-1" style="width: 50%; float: left;"><input type="text" id="first_name" placeholder="First Name" maxlength="20" value="<?php echo $owner['first_name']?>"></div>
                                    <div class="c-offscreen"><label for="Last">Last</label></div>
                                    <div class="c-editor c-span-1" style="width: 50%; float: left;"><input type="text" id="last_name" placeholder="Last Name" maxlength="20" value="<?php echo $owner['last_name']?>"></div>
                                </div>
