	...
	<body class="hold-transition skin-blue sidebar-mini">
		<div class="wrapper">
									...
									<li>
										...
										<ul class="menu">
											...
											<li>
												<a href="#">
													<div class="pull-left">
														<img src="<?=base_url();?>assets/images/user3-128x128.jpg" class="img-circle" alt="User Image">
													</div>
													<h4>
											...
											<li>
												<a href="#">
													<div class="pull-left">
														<img src="<?=base_url();?>assets/images/user4-128x128.jpg" class="img-circle" alt="User Image">
													</div>
													<h4>
														Developers
			...
			<aside class="main-sidebar">
				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu">
						...
						<li style="display:none"><a href="../../documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
			...
			<div class="content-wrapper">
				<?php
					$this->load->view('admin/subpages/'.$sub_page);
				?>
			</div>
			<!-- /.content-wrapper -->
